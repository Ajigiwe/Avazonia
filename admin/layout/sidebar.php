...
<aside class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="products.php" class="nav-item <?= $current_page === 'products.php' || $current_page === 'add-product.php' || $current_page === 'edit-product.php' ? 'active' : '' ?>">
            <span class="nav-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
            </span> Products
        </a>
        <a href="sliders.php" class="nav-item <?= $current_page === 'sliders.php' || $current_page === 'add-slide.php' || $current_page === 'edit-slide.php' ? 'active' : '' ?>">
            <span class="nav-icon">
        ...
        <a href="brands.php" class="nav-item <?= $current_page === 'brands.php' ? 'active' : '' ?>">
            <span class="nav-icon">
        ...
        <a href="orders.php" class="nav-item <?= $current_page === 'orders.php' || $current_page === 'view-order.php' ? 'active' : '' ?>">
            <span class="nav-icon">
