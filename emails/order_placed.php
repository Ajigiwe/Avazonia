...
ob_start(); ?>
<div class="email-hero" style="background: linear-gradient(135deg, #E5001A 0%, #FF4D6D 100%);">
  ...
  <table class="order-table">
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td style="text-align:right; font-weight:700; font-size:15px; color: #E5001A;"><?= $currencySymbol ?><?= number_format($order['total_ghs'], 2) ?></td>
      </tr>
    </tfoot>
  </table>
