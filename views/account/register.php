        ...
        <div style="max-width: 400px; width: 100%; margin: 0 auto;">
            ...
            <div style="background: linear-gradient(135deg, var(--red) 0%, var(--red-deep) 100%); color: #fff; border-radius: 16px; padding: 24px; margin-bottom: 24px;">
                ...
                <ul style="list-style:none;display:flex;flex-direction:column;gap:8px;margin:0;padding:0;font-family:var(--f-mono);font-size:11px;">
                    ...
                    <li style="display:flex;align-items:center;gap:8px;"><span style="display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;background:#fff;color:var(--red);border-radius:50%;font-weight:900;font-size:10px;">✓</span> Get a verified vendor badge</li>
                </ul>
            </div>
            <?php endif; ?>
