...
<nav class="nav" id="main-nav">
    <div class="container-fluid nav-inner">
        ...
        <div class="nav-top">
            ...
            </div>                <!-- Google Translate Widget (desktop nav bar) -->
                <div class="gt-widget-wrap desktop-only"><div id="google_translate_element"></div></div>
                ...
                <div class="nav-account-trigger" id="acc-trigger">
                    ...
                    <div class="acc-dropdown">
                        <?php if (Session::get('user_id')): ?>
                            ...
                            <?php else: ?>
                            <a href="<?= APP_URL ?>/seller/apply" class="acc-link"><?= t('seller.become', 'Become a Seller') ?></a>
                            <?php endif; ?>
